...
2023 年 9 月から 12 月にかけて個人開発し、**2024 年に実際の結婚式で運用しました**。参列者からの回答受付、当日の案内表示まで一通りの役割を終えています。
...
- **ログインが必須のためデモを公開できていません。** 認証と API をモックに差し替えて未ログインでも閲覧できるデモモードを、今後追加する予定です
